...
def fix_banner_css(content: str) -> str:
    ...
    '.button[title="R\u00e9pondre"], a.button[title="R\u00e9pondre"], .post_buttons, .post-buttons, .post-buttons li, form[action*="posting.php"], a[href*="ucp.php?mode=register"], a[href*="ucp.php?mode=login"], a[title="Connexion"], a[title="Inscription"], .quick-login, .headerspace { display: none !important; visibility: hidden !important; }\n'
    ...
    '\n'
    '/* Ensure pagination controls are always visible and usable on the static site */\n'
    '.pagination { clear: both; margin: 0.6em 0; }\n'
    '.pagination ul { list-style: none; margin: 0; padding: 0; display: inline-block; vertical-align: middle; }\n'
    '.pagination ul li { display: inline-block; margin: 0 4px; }\n'
    '.pagination ul li a.button, .pagination ul li span { display: inline-block !important; padding: 6px 10px; border-radius: 6px; text-decoration: none; }\n'
    '.pagination ul li a.button { background: #2b2b2b; color: #fff; }\n'
    '.pagination ul li.active span { background: #777; color: #fff; }\n'
        '</style>\n'
    )
